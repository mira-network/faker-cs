...
namespace Faker
{
	public static class Lorem
	{
		...
		public static string Sentence(int minWordCount)
		{
			if (minWordCount <= 0)
			{
				throw new ArgumentException("Count must be greater than zero", "minWordCount");
			}
		...
		public static IEnumerable<string> Sentences(int sentenceCount)
		{
			if (sentenceCount <= 0)
			{
				throw new ArgumentException("Count must be greater than zero", "sentenceCount");
			}
		...
		public static string Paragraph(int minSentenceCount)
		{
			...
			{
				throw new ArgumentException("Count must be greater than zero", "minSentenceCount");
			}
		...
		public static IEnumerable<string> Paragraphs(int paragraphCount)
		{
			if (paragraphCount <= 0)
			{
				throw new ArgumentException("Count must be greater than zero", "paragraphCount");
			}
